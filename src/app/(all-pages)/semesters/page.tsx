...
export default function SemestersPage() {
  ...
  return (
    <>
      ...
      <div className="ml-10 flex max-h-[100vh] flex-col gap-7 overflow-y-scroll pb-3">
            ...
            >
              ...
              <div className=" mt-5 flex flex-col gap-8 ">
                <div className=" flex flex-col items-start justify-center gap-2 ">
                  <span className="text-[14px] font-medium text-neutral-600 ">Course</span>
                  <Select
                ...
                <div className=" flex flex-col items-start justify-center gap-2 ">
                  <span className="text-[14px] font-medium text-neutral-600 ">Semester</span>
                  <Select
                ...
                <div className=" flex flex-col items-start justify-center gap-2 ">
                  <span className="text-[14px] font-medium text-neutral-600 ">Duration</span>
                  <div className="flex w-full items-center justify-between gap-3">
                    ...
                    />
                    <span className=" text-[14px] font-semibold text-neutral-600">To</span>
                    <DatePicker
                      align=" top"
                      name="end"
                ...
                <div className=" flex flex-col items-start justify-center gap-2 ">
                  <span className="text-[14px] font-medium text-neutral-600 ">Semester Color</span>
                  <Popover>
                    <PopoverTrigger className="flex w-full items-center justify-start gap-2 rounded-md border border-[#cbd5e1a7] px-3 py-2">
                      {watchSemester("color") === "" ? (
                        <>
                          ...
                          <span className="text-[16px] font-normal text-neutral-900">N/A</span>
                        </>
                      ) : (
                        <>
                          <div
        ...
        <div className="flex max-w-[40vw] flex-row items-center justify-start gap-2">
          ...
          <p className="text-[28px] font-semibold text-neutral-700">Semesters</p>
          {profile && profile.permissions.includes(PERMISSIONS.CREATE_SEMESTER) && (
            <button
              onClick={() => {
          ...
          {isLoading ? (
            ...
            <>
              {semesters?.data?.data.map((semester: Semester) => (
                <div
                  key={semester._id}
                  className="flex w-full flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-4 py-2"
                >
                  <div
                    style={{
                  ...
                  <div className="ml-auto flex h-full items-center justify-center">
                    <Popover>
                      ...
                      >
                        {profile && profile.permissions.includes(PERMISSIONS.UPDATE_SEMESTER) && (
                          <div
                            onClick={() => {
                        ...
                        <hr />
                        {profile && profile.permissions.includes(PERMISSIONS.DELETE_SEMESTER) && (
                          <div
                            onClick={() => {
