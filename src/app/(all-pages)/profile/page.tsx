...
import { MdImportExport, MdOutlineChangeCircle, MdOutlineModeEdit } from "react-icons/md";
...
export default function ManageDepartment() {
  ...
  return (
    <>
      ...
      <div className="ml-10 flex h-[100vh] max-h-[100vh] flex-col gap-6 overflow-y-scroll">
              ...
              <div className="relative flex h-[105px] w-full items-center justify-center rounded-[4px] border border-dashed border-[#D0D5DD] bg-primary-50 ">
                ...
                <div className=" flex w-[240px] cursor-pointer flex-col items-center gap-[10px]">
                  ...
                  <p className="text-center text-[13px] font-normal text-neutral-500">
                    Browse and choose the image you want to upload from your device
                  </p>
                </div>
              </div>
            </div>
        ...
        <Dialog open={changePasswordModalOpen} onOpenChange={setChangePasswordModalOpen}>
          <DialogContent>
            ...
            >
              <h1 className=" w-full text-center text-[20px] font-bold">Change Password</h1>
        ...
        <div className="flex flex-col items-start justify-start gap-4">
          <div className="flex flex-row items-center justify-start gap-2.5">
            ...
            <div className="flex flex-col items-start justify-center gap-2">
              <p className="text-[16px] font-semibold text-neutral-600">{profileData?.username}</p>
          ...
          <div className="mt-4 flex flex-col gap-5">
            {profileData && profileData.permissions && profileData.permissions.length > 0 && (
              <>
                <span className="text-[16px] font-semibold text-neutral-800">Permissions</span>
                <div className="mt-2 flex flex-col items-start justify-start gap-2.5">
                  {profileData?.permissions
                    ...
                    .map((permission: string) => (
                      <div key={permission} className={`flex items-center justify-start gap-2.5`}>
                  ...
                  {!permissionsExpanded && profileData?.permissions.length > 2 && (
                    <span
            ...
            <div className=" flex w-[40vw] cursor-pointer flex-col items-start justify-start gap-6">
              ...
              >
                ...
                <span className="text-[16px] font-semibold text-neutral-900">Change Password</span>
              </div>
              <Link
                href={"/semesters"}
                className="flex w-full flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-3 py-1.5"
              >
                ...
                <span className="text-[16px] font-semibold text-neutral-900">Semesters</span>
              </Link>
              <Link
                href={"/location"}
                className="flex w-full flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-3 py-1.5"
              >
                ...
                <span className="text-[16px] font-semibold text-neutral-900">Location</span>
              </Link>
              <Link
                href={"/importExport"}
                className="flex w-full flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-3 py-1.5"
              >
                ...
                <span className="text-[16px] font-semibold text-neutral-900">Import/Export</span>
              </Link>
              {profileData?.syncWithGoogle ? (
                <div className="flex w-full flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-3 py-1.5">
                  ...
                  <div className="flex flex-row gap-1">
                    <span className="text-[13px] font-semibold text-neutral-900">Synced With</span>
                ...
                <div
                  ...
                  className="mb-5 flex w-full cursor-pointer flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-3 py-1.5"
                >
                  <div className=" flex h-11 w-11 items-center justify-center rounded-md bg-neutral-200 text-[20px] text-neutral-400">
