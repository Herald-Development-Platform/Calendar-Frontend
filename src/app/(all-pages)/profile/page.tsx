...
import { MdOutlineChangeCircle, MdOutlineModeEdit } from "react-icons/md";
            ...
            >
              <span className="flex h-full items-center justify-center">
                {profileData?.role === ROLES.SUPER_ADMIN
                  ? "Super Admin"
                  : profileData?.role === ROLES.DEPARTMENT_ADMIN
                    ? "Department Head"
                    : "User"}
              </span>
            </div>
              ...
              <div className="flex w-full flex-row items-center justify-start gap-4 rounded-md bg-neutral-100 px-3 py-1.5">
                ...
                <div className="ml-auto">
                  <Popover>
                    ...
                    <PopoverContent
                      onClick={() => {
                        updateProfileMutation.mutate({ syncWithGoogle: false });
                      }}
                      align="start"
