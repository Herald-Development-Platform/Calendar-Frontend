...
const NewMembersAction = ({ actionId }: { actionId: string }) => {
  ...
  return (
    <div className=" flex h-8 flex-row gap-4 ">
      <button
        className=" text-500 flex items-center justify-center gap-2 rounded-md bg-success-500 px-4 py-2 text-[13px] text-white"
        onClick={() => {
      ...
      <button
        className="text-500 flex items-center justify-center gap-2 rounded-md bg-danger-500 px-4 py-2 text-[13px] text-white"
        onClick={() => {
